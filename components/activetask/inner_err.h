...
#define INNER_N2N_ERR_BASE          0x420000
#define N2N_EMPTY_DEV_INFO          (INNER_N2N_ERR_BASE+ 1)
#define N2N_DEV_PARSE_FAILED        (INNER_N2N_ERR_BASE+ 2)
#define N2N_DEV_MALLOC_FAILED       (INNER_N2N_ERR_BASE+ 3)
#define N2N_DEV_NAME_MISSED         (INNER_N2N_ERR_BASE+ 4)
#define N2N_DEV_ROUTE_MISSED        (INNER_N2N_ERR_BASE+ 5)
#define N2N_DEV_SCHEMA_MISSED       (INNER_N2N_ERR_BASE+ 6)
#define N2N_DEV_TYPE_MISSED         (INNER_N2N_ERR_BASE+ 7)
#define N2N_DEV_CHILD_MISSED        (INNER_N2N_ERR_BASE+ 8)
#define N2N_DEV_CHILDREN_FAILED     (INNER_N2N_ERR_BASE+ 9)
#define N2N_DEV_JSON_FAILED         (INNER_N2N_ERR_BASE+10)
